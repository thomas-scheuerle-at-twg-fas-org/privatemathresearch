...
The theorem is stronger than a merely heuristic analogy between the Somos
recurrence and the convergents: it gives a precise finite-level carrier of the
Somos dynamics.  At the same time, it identifies the correct limiting scale.
